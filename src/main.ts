...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription(
      'Iolanda Fashion API developed by Victor Hugo.<br><br><a href="https://github.com/Victor0C" target="_blank">GitHub</a> | <a href="https://www.linkedin.com/in/victorhugooc/" target="_blank">LinkedIn</a>',
    )
    .setVersion('1.0')
    .addBearerAuth()
    .build();
