...
export class FilterErrors implements ExceptionFilter {
    constructor(private readonly logger: ConsoleLogger){}
        ...
        if('user' in request) this.logger.log(`\x1b[33m Route accessed by the user ${request.user.sub} \x1b[33m`)
        this.logger.log(`\x1b[33m${request.method} ${request.path}\x1b[33m`)
        this.logger.log(`\x1b[33m Body request: ${(JSON.stringify(request.body))}\x1b[33m`)
