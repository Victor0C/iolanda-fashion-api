...
export class CreateTables1712100737487 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "procedures_perfomed" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "amount" integer NOT NULL, "price" numeric(10,2) NOT NULL, "procedureId" uuid, "saleId" uuid, CONSTRAINT "PK_cd4068bad57d9e0d6a9379f5146" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "products_sold" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "amount" integer NOT NULL, "price" numeric(10,2) NOT NULL, "productId" uuid, "saleId" uuid, CONSTRAINT "PK_a3db353ea2a013da09938b2aa86" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "procedures_perfomed" ADD CONSTRAINT "FK_bd7a8708b3d8fca3aded9a30451" FOREIGN KEY ("saleId") REFERENCES "sales"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "products_sold" ADD CONSTRAINT "FK_19ece72dceed357de61d85f02aa" FOREIGN KEY ("saleId") REFERENCES "sales"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
